...
## Creamos un contenedor para eliminar posibles carácteres especiales del corpus y hacemos un inspect antes y después para observar posibles cambios
```{r}
...
corp <- tm_map(corp, toSpace, "<d5>")
corp <- tm_map(corp, toSpace, "<d1>")
corp <- tm_map(corp, toSpace, "\f")
